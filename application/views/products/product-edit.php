<div class="content-body">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group">
                                ...
                                <input type="text" name="product_price" class="form-control required"
                                       ...
                                       value="<?php echo $product['fproduct_price'] ? $product['fproduct_price'] * 1.5 : 0.00 ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
    ...
    <div class="col-sm-6">
        ...
        <small class="form-text text-muted">
            <?php echo $this->lang->line('This price is the average of all purchase prices.'); ?>
        </small>
    </div>
</div>

<div class="form-group row">
    <label class="col-sm-2 col-form-label"><?php echo $this->lang->line('All Purchase Prices') ?></label>
    <div class="col-sm-6">
        <div class="form-control" style="background-color: #f9f9f9; border: 1px solid #ddd;">
            <?php if (!empty($purchase_prices)) : ?>
                <?php 
                $aauth = $this->aauth; // Assign $this->aauth to a variable
                $prices = array_map(function($price) use ($aauth) {
                    return edit_amountExchange_s($price['price'], 0, $aauth->get_user()->loc);
                }, $purchase_prices);
                echo implode(', ', $prices);
                ?>
            <?php else : ?>
                <?php echo $this->lang->line('No Purchase Prices Found'); ?>
            <?php endif; ?>
        </div>
    </div>
</div>
