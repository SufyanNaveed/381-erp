                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control shipping" name="product_shipping[]"
                                            onkeypress="return isNumber(event)" id="shipping-0"
                                            onkeyup="rowTotal('0'), billUpyog()" autocomplete="off"></td>
                                    <td><span class="currenty"><span class="selectedCurrency">﷼</span>
</span>
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    ...
                                    <td align="left" colspan="2"><span
                                            class="currenty lightMode"><span class="selectedCurrency">﷼</span>
</span>
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    ...
                                    <span id="shippings" class="lightMode">0</span>
