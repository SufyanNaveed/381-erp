...
<div class="invoice-box">
    ...
    <table class="plist" cellpadding="0" cellspacing="0">
        <tr class="heading">
            ...
            <td>
                <?php echo $this->lang->line('Price') ?>   (<?php echo $invoice['currency_code'] ?>) 
            </td>
            <td>
        ...
        foreach ($products as $row) {
            ...
            echo '<td class="t_center">' . $row['shipping'] . '</td></tr>';
    ...
    <table>
        ...
        <tr>
         ...
         <!-- <td><?php
                ...
                <?php echo
                    '<p>Beneficiary name: مؤسسة مستقبل البيانات التجارية
</p>                 <p>IBAN: SA8880000471608016246746</p>
                <p>Account Currency: SAR</p>
                <p>Bank: AL RAJHI BANK</p> </div>';?>
            </td> -->
        </tr>
        </tbody>
    </table>
